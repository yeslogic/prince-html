...
#define NUM_NAMED_CHARS 2231
#define NUM_SECOND_CODE_POINTS 93

const unsigned char* named_chars[NUM_NAMED_CHARS][2] = {
	{"AElig", 			"0x000C6"},
	{"AMP", 			"0x00026"},
	{"Aacute", 		"0x000C1"},
	{"Abreve", 		"0x00102"},
...
const unsigned char* second_code_points[NUM_SECOND_CODE_POINTS][2] = {
	{"NotEqualTilde",	"0x00338"},
	{"NotGreaterFullEqual",	"0x00338"},
	{"NotGreaterGreater",	"0x00338"},
	{"NotGreaterSlantEqual",	"0x00338"},
	{"NotHumpDownHump",	"0x00338"},
	{"NotHumpEqual",	"0x00338"},
	{"NotLeftTriangleBar",	"0x00338"},
	{"NotLessLess",	"0x00338"},
	{"NotLessSlantEqual",	"0x00338"},
	{"NotNestedGreaterGreater",	"0x00338"},
	{"NotNestedLessLess",	"0x00338"},
	{"NotPrecedesEqual",	"0x00338"},
	{"NotRightTriangleBar",	"0x00338"},
	{"NotSquareSubset",	"0x00338"},
	{"NotSquareSuperset",	"0x00338"},
	{"NotSubset",	"0x020D2"},
	{"NotSucceedsEqual",	"0x00338"},
	{"NotSucceedsTilde",	"0x00338"},
	{"NotSuperset",	"0x020D2"},
	{"ThickSpace",	"0x0200A"},
	{"acE",	"0x00333"},
	{"bne",	"0x020E5"},
	...
	{"sqcaps",	"0x0FE00"},
	{"sqcups",	"0x0FE00"},
	{"varsubsetneq",	"0x0FE00"},
	{"varsubsetneqq",	"0x0FE00"},
	{"varsupsetneq",	"0x0FE00"},
	{"varsupsetneqq",	"0x0FE00"},
	{"vnsub",	"0x020D2"},
	{"vnsup",	"0x020D2"},
	{"vsubnE",	"0x0FE00"},
	{"vsubne",	"0x0FE00"},
...
/*if char_to_check is a named character, evaluate code_point and return 1, otherwise return 0*/
int is_named_char_ref(unsigned char *char_to_check, unsigned long *code_point)
{
	int i;
	unsigned char *following_char;

	for(i = 0; i < NUM_NAMED_CHARS; i++)
	{
		if(strcmp(char_to_check, named_chars[i][0]) == 0)
		{
			*code_point =strtol(named_chars[i][1], &following_char, 16);
			return 1;
		}
	}
...
int has_second_code_point(unsigned char *char_to_check, unsigned long *code_point)
{
	...
	for(i = 0; i < NUM_SECOND_CODE_POINTS; i++)
	{
		if(strcmp(char_to_check, second_code_points[i][0]) == 0)
		{
			*code_point = strtol(second_code_points[i][1], &following_char, 16);
			return 1;
		}
	}
...
{
	if(((code_point >= 0x0001) && (code_point <= 0x0008)) ||
